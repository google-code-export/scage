...
public class TrueTypeFont
{
	...
	private static TrueTypeFont instance;
	public static TrueTypeFont instance()
	{
		if (instance == null)
		{
			Font font = new Font(Font.MONOSPACED, Font.BOLD, /*font_size*/18);
	        /*char[] cyrillic = {'�', '�', '�', '�', '�', '�', '�', '�', '�', '�', '�', '�', '�', '�',
	        				   '�', '�', '�', '�', '�', '�', '�', '�', '�', '�', '�', '�', '�', '�',
	        				   '�', '�', '�', '�', '�',
	        				   '�', '�', '�', '�', '�', '�', '�', '�', '�', '�', '�', '�', '�', '�',
	        				   '�', '�', '�', '�', '�', '�', '�', '�', '�', '�', '�', '�', '�', '�',
	        				   '�', '�', '�', '�', '�'};*/
	        instance = new TrueTypeFont(font, true/*, cyrillic*/);
		}
		return instance;
	}
	...
	private void createSet( char[] customCharsArray ) {
		...
		try {
			...
			imgTemp = new BufferedImage(textureWidth, textureHeight, BufferedImage.TYPE_INT_ARGB);
	...
	public void drawString(String whatchars, float x, float y)
	{
		this.drawString(x, y, whatchars, 1.0f, 1.0f);
	}

	public void drawString(String whatchars, float x, float y, su.msk.dunno.scage2.support.Color c)
	{
		GL11.glPushMatrix();
	...
	public void drawString(float x, float y,
		...
		/*scaleX = scaleX*screen_size/font_size;
		scaleY = scaleY*screen_size/font_size;*/
		...
		while (i >= startIndex && i <= endIndex) {
			...
			{
				GL11.glColor3f(default_color.get(0), default_color.get(1), default_color.get(2));
				i += d;
				continue;
			}
	...
	public void saveTexture(String filepath)
	{
		if(imgTemp != null)
		{
			try
			{
				ImageIO.write(imgTemp, "png", new File(filepath));
			}
			catch (IOException e)
			{
				e.printStackTrace();
